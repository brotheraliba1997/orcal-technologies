...
{/* <AnimationBackGround > */}
   ...
   <section className="text-white  ">
      ...
      <div className="relative  grid grid-cols-1 lg:grid-cols-2 items-center gap-10 md:px-10 px-4 ">
        <motion.div
        ...
        <div>
          <p className="lg::text-lg md:text-2xl text-sm text-[#BBBBBB] leading-relaxed">
